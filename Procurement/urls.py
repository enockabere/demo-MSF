...
urlpatterns = [
    ...
    path('PurchaseApprove/<str:pk>',
         views.PurchaseApproval.as_view(), name='PurchaseApprove'),
    path('PurchaseCancel/<str:pk>',
         views.FnCancelPurchaseApproval.as_view(), name='PurchaseCancel'),
    path('FnDeletePurchaseRequisitionLine/<str:pk>',
         views.FnDeletePurchaseRequisitionLine.as_view(), name='FnDeletePurchaseRequisitionLine'),
    path('FnGeneratePurchaseReport/<str:pk>',
         views.FnGeneratePurchaseReport.as_view(), name='FnGeneratePurchaseReport'),
    path('UploadPurchaseAttachment/<str:pk>',
         views.UploadPurchaseAttachment.as_view(), name='UploadPurchaseAttachment'),
    path('DeletePurchaseAttachment/<str:pk>',
         views.DeletePurchaseAttachment.as_view(), name='DeletePurchaseAttachment'),
